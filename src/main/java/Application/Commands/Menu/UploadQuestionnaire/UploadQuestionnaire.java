...
public class UploadQuestionnaire extends WindowMenu {
    public void ButtonUploadQuestionnaire(){
        WindowMenu.dw.addActionListener(e -> {
            EmployeeAccounting.app3.setVisible(true);
